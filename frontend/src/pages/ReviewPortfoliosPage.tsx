...
export const ReviewPortfoliosPage = () => {
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold truncate">{selectedPortfolio.studentName}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <BookOpen className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
                        <span className="truncate">{selectedPortfolio.subject}</span>
                      </div>
                      <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 text-base sm:text-lg font-semibold text-gray-900">
                      ...
                      <span>Documento del Portafolio</span>
                    </div>
                    ...
                    <Card className="bg-gray-50">
                      <CardContent className="pt-4 space-y-2 text-xs sm:text-sm">
                        <div className="flex justify-between gap-2">
                          <span className="text-gray-600 flex-shrink-0">Carrera:</span>
                          <span className="font-medium truncate text-right" title={selectedPortfolio.career}>
                            {selectedPortfolio.career}
                          </span>
                        </div>
                        <div className="flex justify-between gap-2">
                          <span className="text-gray-600 flex-shrink-0">Semestre:</span>
                          <span className="font-medium truncate text-right" title={selectedPortfolio.semester}>
                            {selectedPortfolio.semester}
                          </span>
                        </div>
                        <div className="flex justify-between gap-2">
                          <span className="text-gray-600 flex-shrink-0">Horario:</span>
                          <span className="font-medium truncate text-right" title={selectedPortfolio.classSchedule}>
                            {selectedPortfolio.classSchedule}
                          </span>
                        </div>
                        <div className="flex justify-between gap-2">
                          <span className="text-gray-600 flex-shrink-0">Archivo:</span>
                          <span className="font-medium truncate text-right" title={selectedPortfolio.fileName}>
                            {selectedPortfolio.fileName}
                          </span>
                        </div>
                        <div className="flex justify-between gap-2">
                          <span className="text-gray-600 flex-shrink-0">Tamaño:</span>
                    ...
                    <div>
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                        <div className="flex items-center gap-2 text-base sm:text-lg font-semibold text-gray-900">
                          ...
                          <span>Evaluación con Rúbrica</span>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          >
                            ...
                            <span className="text-sm sm:text-base">Aprobar Portafolio</span>
                          </Button>
                          <Button
                          ...
                          >
                            ...
                            <span className="text-sm sm:text-base">Rechazar Portafolio</span>
                          </Button>
                        </div>
                        <Button
